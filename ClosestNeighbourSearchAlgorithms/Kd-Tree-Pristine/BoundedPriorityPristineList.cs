...
namespace ClosestNeighbourSearchAlgorithms
{
    ...
    public class BoundedPriorityPristineList<TElement, TPriority> : IEnumerable<TElement>
        where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// Gets the maximum allows capacity for the <see cref="BoundedPriorityPristineList{TElement,TPriority}"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoundedPriorityPristineList{TElement,TPriority}"/> class.
        /// Note: You should not have <paramref name="allocate"/> set to true, and the capacity set to a very large number.
        /// Especially if you will be creating and destroying many <see cref="BoundedPriorityPristineList{TElement,TPriority}"/> very rapidly.
        ...
        /// <param name="allocate">If true, initializes the internal lists for the <see cref="BoundedPriorityPristineList{TElement,TPriority}"/> with an initial capacity of <paramref name="capacity"/>.</param>
        public BoundedPriorityPristineList(int capacity, bool allocate = false)
        {
