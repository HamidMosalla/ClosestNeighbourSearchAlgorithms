...
namespace ClosestNeighbourSearchAlgorithms
{
    ...
    public class BoundedPriorityListCoordinate<TElement, TPriority> : IEnumerable<TElement> where TPriority : IComparable<TPriority>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the maximum allows capacity for the <see cref="BoundedPriorityListCoordinate{TElement,TPriority}"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoundedPriorityListCoordinate{TElement,TPriority}"/> class.
        /// Note: You should not have <paramref name="allocate"/> set to true, and the capacity set to a very large number.
        /// Especially if you will be creating and destroying many <see cref="BoundedPriorityListCoordinate{TElement,TPriority}"/> very rapidly.
        ...
        /// <param name="allocate">If true, initializes the internal lists for the <see cref="BoundedPriorityListCoordinate{TElement,TPriority}"/> with an initial capacity of <paramref name="capacity"/>.</param>
        public BoundedPriorityListCoordinate(int capacity, bool allocate = false)
        {
