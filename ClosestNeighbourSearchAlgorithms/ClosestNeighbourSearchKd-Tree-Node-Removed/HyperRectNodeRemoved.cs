...
namespace ConsoleSandBox.KDTree
{
    /// <summary>
    ...
    public struct HyperRectNodeRemoved<T> where T : IComparable<T>
    {
        /// <summary>
        ...
        public static HyperRectNodeRemoved<T> Infinite(int dimensions, T positiveInfinity, T negativeInfinity)
        {
            var rect = default(HyperRectNodeRemoved<T>);
        ...
        /// <summary>
        /// Clones the <see cref="HyperRectNodeRemoved{T}"/>.
        /// </summary>
        /// <returns>A clone of the <see cref="HyperRectNodeRemoved{T}"/></returns>
        public HyperRectNodeRemoved<T> Clone()
        {
